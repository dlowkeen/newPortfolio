export default [
  {
    ...
    responsibilities:"Backend API calls with AJAX, Firebase, JavaScript. Google login."
  },
  {
    ...
    responsibilities:"Front end design, Routing, and app structure."
  },
  {
    href:'https://socialspaces.life/',
    src: require("../../../assets/images/socialspaces.png"),
    alt:"SocialSpaces",
    name:"Social Spaces",
    description:"Find roommates that match your personal, professional and spiritual goals through a co-living space.",
    responsibilities:"Front end development with React.js."
  },
  {
  ...
  },
  {
    ...
    src:require('../../../assets/images/groupr.png'),
    alt:"Groupr",
    name:"Groupr",
    description:"Hub for high quality tech networking events. Built with MERN stack.",
    responsibilities:"Recruiter and Quiz form using Redux-Form, MongoDB CRUD operations using mongoose."
  }
];
